...
I'm a 3rd year BSMS student majoring in **Physics** with a **Data Science minor** at the Indian Institute of Science Education and Research (IISER) Mohali. I work at the intersection of computational physics and biophysics and running molecular dynamics simulations to understand soft matter and biological membranes. I am also intrested in simulating AICD.

Currently I am a **Project Worker at the [Skepö Research Group, Lund University](https://portal.research.lu.se/sv/persons/marie-skep%C3%B6/)** and an open source Contributor at the **[NMRLipids](https://github.com/NMRLipids/BilayerData)** databank UiB Norway.


##  Research Interests 

- **Molecular Dynamics Simulation** : lipid bilayer systems, force field validation
- **Computational Biophysics** : membrane physics, fluctuation analysis, Intrincically Disordered Proteins
- **Soft Matter Biophysics** : phase transitions, membrane dynamics


##  Tech Stack

**HPC user** - LUNARC COSMOS by Lund University and Dardel PDC by KTH Royal University of Sweden under National Academic Infrastructure for Supercomputing in Sweden (NAISS)
 ...
 **Co-Convenor** of the Organising Committee while being **Logistics and Security Head** of **INSOMNIA : Cultural Fest, IISERM** *(2026)*
